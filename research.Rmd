...
### Reserch interests: 
- Survial & event history analysis
- Stochastic processes
- Generative AI
- Bayesian Statistics
- Non-paramteric and semi-parametric inference.
- Caual inference
- Sensitivity Analysis
- Life Course & Intergenerational Epidemiology
...
Another major interest is causal inference in observational data,
...
Key application areas include life-course outcomes and intergenerational effects—both challenging to study in randomized clinical trials.
